...
if options.file is not None:
    ...
    "/dev/serial/by-id/usb-3D_Robotics_PX4_BL_FMU_v2.x_0-if00,/dev/serial/by-id/usb-3D_Robotics_PX4_FMU_v2.x_0-if00,/dev/serial/by-id/usb-ArduPilot_Pixhawk1_200042000E51343032383731-if00 "
    "'%s'" % options.file) != 0):
